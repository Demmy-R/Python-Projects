...
print("There are " +str(adult) +" adults riding this train, each riding " +str(adult_miles) + " mile(s), and the total cost is $" +str(adult_total) + "\n")
...
print("There are " +str(kids) +" kids riding this train, each riding " +str(kids_miles) + " mile(s), and the total cost is $" +str(kids_total) + "\n")
